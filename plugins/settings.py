...
from bot.database.models.settings_db import add_grid_size, add_list_size,add_subs_limit,get_settings
...
@Bot.on_callback_query(filters.regex('^grid_size$') &(filters.user(get_admin()) | filters.user(SUDO_USERS)))
